<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeBehind="patienteditprofile.aspx.cs" Inherits="hospital_management_system.patienteditprofile" %>
...
<div class="container" id="register_page_container" style="align-content:center;margin-left:200px;margin-right:100px;width:1050px;height:2000px;margin-top:50px;padding-top:15px;">
    <form class="form-horizontal" runat="server" style="background-color:#f5f5f5;border-color:aqua;border:thin;" >
        ...
        <div class="form-group" style="align-content:center;height:200px;padding-left:50px;">
            ...
            <div class="col-sm-8"   style="height:15px;padding-top:15px;">
        ...
        <div class="form-group">               
            <asp:Label CssClass="col-sm-2 control-label" runat="server" ID="first_name_lb">Name</asp:Label>
                <div class="col-sm-3">
                    <asp:TextBox CssClass="form-control" ID="first_name_tb" runat="server" placeholder="First Name" required="true" ></asp:TextBox>
                </div>
                <div class="col-sm-3">
                    <asp:TextBox CssClass="form-control" ID="mid_name_tb" runat="server" placeholder="Middle Name" required="true"></asp:TextBox>
                </div>
                <div class="col-sm-3">
                    <asp:TextBox CssClass="form-control" ID="last_name_tb" runat="server" placeholder="Last Name" required="true"></asp:TextBox>
                </div>
         </div>
         <div class="form-group">
        ...
        <blockquote style="height:1px;background-color: #ededef;">
            ...
            <div class="form-group">
             ...
             <div class="form-group" style="padding-left:150px;">
                <asp:Button runat="server" ID="edit_btn" CssClass=" btn btn-danger" BorderStyle="None"  Text="Edit" OnClick="edit_btn_Click" Enabled="true"/>
                 &nbsp;&nbsp;&nbsp;<input type="reset" id="reset_btn" class="btn btn-danger"  style="border-style:none;" />
            </div>
    </form>
</div>    
