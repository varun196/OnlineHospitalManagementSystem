<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminEditDoctor.aspx.cs" Inherits="hospital_management_system.AdminEditDoctor" %>
           ...
           <form class="form-horizontal" runat="server" style="align-content:center;padding-left:100px;">
                   ...
                   <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-4">      
                            <asp:TextBox TextMode="Date" runat="server" Text=" " CssClass="form-control" ID="dob" required="true" placeholder="Date of Birth"/>
            ...
            <div class="form-group" style="padding-left:150px;">
               <asp:Button runat="server" CausesValidation="false" ID="register_btn" CssClass=" btn btn-danger" BorderStyle="None"  Text="Update" OnClick="register_btn_Click"/> 
            </div>
            
         <asp:label id="ErrorL" runat="server" visible="false  " ></asp:label>
        </form>
    </div>
